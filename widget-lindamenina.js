(function () {
    // ===============================================
    // PROVADOR DESATIVADO ("tirado do ar")
    // Para reativar, altere PROVADOR_ATIVO para true.
    // ===============================================
    var PROVADOR_ATIVO = false;
    if (!PROVADOR_ATIVO) return;
    ...
    // ===============================================
    const apiKey = "pl_live_79c7c6a3a482409fe4729be7589d5e079a4fa6c87dd7d9727f5dc7549ca9b90c";
    ...
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/lindamenina-check-limit';
...
/* PL: borda arredondada do modal */@media(min-width:768px){.q-card-ia,.q-card,#q-card-ia,#q-card,.q-modal-card{border-radius:16px !important;overflow:hidden;}}
        ...
        /* logo do fornecedor removido — Linda Menina e white-label */
    `;
            ...
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-step-pix">
                        ...
                        <p style="font-size: 11px; color: var(--c-muted); margin: 8px 0 0; line-height: 1.5; text-align: center;">&#8505;&#65039; Cobran&#231;a processada por nosso parceiro de tecnologia, n&#227;o pela loja</p>
    ...
    function init() {
        ...
        function makeSelo() {
            ...
            b.addEventListener('click', function (_e) { window.__plBtnSrc = 'selo'; openProvador(_e); });
            return b;
        }
